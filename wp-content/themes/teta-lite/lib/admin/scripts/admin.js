(function ($) {
    ...
    function menuDependencies() {
        ...
        $(document).on('change',"input[name^='is-boxed-item']",function(e) {
            e.stopPropagation();
            specificItemHandle();
        });
        ...
        function specificItemHandle(){
            $("input[name^='is-boxed-item']").each(function () {
                if ($(this).prop('checked') == true) {
                    $(this).parents('li').addClass('is-boxed-item');
                } else {
                    $(this).parents('li').removeClass('is-boxed-item');
                }
            });
        }

...
if ( ! class_exists( 'Redux' ) ) {
	...
	Redux::setSection(
		...
		array(
			...
			'fields' => array(
				...
				array(
					'id'     => 'lite_option_j6v3ejvplvk',
					'type'   => 'section',
					'indent' => true,
					'title'	 => esc_html( 'Responsive Header Settings', 'teta-lite' ),
				),
				array(
					'id'       => 'lite_option_l795npegxyj',
					'type'     => 'switch',
	...
	Redux::setSection(
		...
		array(
			...
			'fields' => array(
				...
				array(
					'id'     => 'lite_option_7jqtfdythnd',
					'type'   => 'section',
					'title'  => esc_html__( 'Promo Bar Height', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'            => 'lite_option_g929ex4bs5',
					'type'          => 'slider',
				...
				array(
					'id'     => 'lite_option_dfp8wdmrmsc',
					'type'   => 'section',
					'indent' => false,
				),
				array(
					'id'     => 'lite_option_06a48aa3qkid',
					'type'   => 'section',
					'title'  => esc_html__( 'Promo Bar Background Style', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_kn6swem8li',
					'type'     => 'media',
					'operator' => 'and',
				...
				array(
					'id'     => 'lite_option_w3ddbpx601',
					'type'   => 'section',
					'indent' => false,
				),
				array(
					'id'       => 'lite_option_u1fyt4w5dwg',
					'type'     => 'switch',
		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'type'     => 'image_select',
					'title'    => esc_html__( 'Blog Detail Sidebar', 'teta-lite' ),
					'subtitle' => esc_html__( 'Here you can disable or enable the sidebar for your blog detail.', 'teta-lite' ),
					// Must provide key => value(array:title|img) pairs for radio options
					'options'  => array(
						'no-sidebar'   => array(
							'alt' => 'no-sidebar',
				...
				array(
					...
					'type'     => 'switch',
					'title'    => esc_html__( 'Enable this option if you want fixed sidebar style in blog and blog deatil pages', 'teta-lite' ),
					'on'       => esc_html__( 'Enable', 'teta-lite' ),
					'off'      => esc_html__( 'Disable', 'teta-lite' ),
					'default'  => false,
				),
	...
	Redux::setSection(
		...
		array(
			...
			'fields' => array(
				...
				array(
					'id'     => 'lite_option_e7s8elvb2ea',
					'type'   => 'section',
					'title'  => esc_html__( 'Products Pagination', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_nmlz7d6m2c',
					'type'     => 'select',
				...
				array(
					'id'     => 'lite_option_y61u90vez5',
					'title'	 =>	esc_html( 'Product Variations', 'teta-lite' ),
					'type'   => 'section',
					'indent' => true,
				),
				array(
					'id'      => 'lite_option_wtc1nebpp5r',
					'type'    => 'switch',
				...
				array(
					'id'     => 'lite_option_ar0q1fnar7',
					'type'   => 'section',
					'title'  => esc_html__( 'Recently Viewed Products', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_ynu3yvk1pkl',
					'type'     => 'switch',
					'title'    => esc_html__( 'Recently viewed products', 'teta-lite' ),
				...
				array(
					'id'     => 'lite_option_2zck2n9rswh',
					'type'   => 'section',
					'indent' => false,
				),
				array(
					'id'     => 'lite_option_40yn2kxa5z2',
					'title'  => esc_html__( 'Catalog Mode', 'teta-lite' ),
					'type'   => 'section',
					'indent' => true,
				),
				array(
					'id'      => 'lite_option_646tvurew7v',
					'type'    => 'switch',
				...
				array(
					'id'     => 'lite_option_26e1mg4o2axi',
					'type'   => 'section',
					'title'	 => esc_html__( 'Widgets Settings', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_d4c6c2cj0q9',
					'type'     => 'switch',
				...
				array(
					'id'     => 'lite_option_kx4skxgtcj',
					'type'   => 'section',
					'indent' => false,
				),
				array(
					'id' 		=> 'lite_option_yhw7t4k044c',
					'type' 		=> 'section',
					'title' 	=> esc_html__( 'Shop Extra Templates', 'teta-lite' ),
					'indent' 	=> true,
				),
				array (
					'id'       => 'lite_option_hmcc24pa72r',
					'type'     => 'switch',
				...
				array(
					'id' => 'lite_option_950u4npqqm',
					'type' => 'section',
					'indent' => false,
				),
				array(
					'id' => 'lite_option_uwmbnlqxz8',
					'type' => 'section',
					'title' =>esc_html__( 'Shop Extra Options', 'teta-lite' ),
					'indent' => true,
				),
				array (
					'id'       => 'lite_option_v43bxc8zkl',
					'type'     => 'switch',
	...
	Redux::setSection(
		...
		array(
			...
			'id'     => 'lite_option_6vp9y290h5',
			'icon'   => 'icon-truck',
			'subsection' => true,
			'fields' => array(
				array (
					'id'       => 'lite_option_g7rrhdi3dbg',
					'type'     => 'switch',
	...
	Redux::setSection(
		...
		array(
			...
			'fields' => array(
				...
				array(
					'id'     => 'lite_option_djj2889korc',
					'type'   => 'section',
					'title'	 => esc_html__( 'Add to cart', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_w99cjyjniq',
					'type'     => 'switch',
	...
	Redux::setSection(
		...
		array(
			...
			'id'     => 'lite_option_3w5wuv3m1my',
			'icon'   => 'icon-cart-full',
			'subsection' => true,
			'fields' => array(
				array(
					'id'       => 'lite_option_fpupyrwgbrm',
					'type'     => 'switch',
				...
				array(
					'id'     => 'lite_option_fc4zhvd9aav',
					'type'   => 'section',
					'title'  => esc_html__( 'Size Guide', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_hroebysivhd',
					'type'     => 'text',
					'title'    => esc_html__( 'Title', 'teta-lite' ),
				...
				array(
					'id'       => 'lite_option_6dtue9fnlc',
					'type'     => 'editor',
					'class'    => 'kt-pro-feature'
				),
				array(
					'id'     => 'lite_option_4bv3owfbshn',
					'type'   => 'section',
					'indent' => false,
				),
				array(
					'id'     => 'lite_option_a3b4jszivi',
					'type'   => 'section',
					'title'    => esc_html__( 'Delivery & Return', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_krkhwgkpaud',
					'type'     => 'text',
					'title'    => esc_html__( 'Title', 'teta-lite' ),
				...
				array(
					'id'       => 'lite_option_nuomnt6w5g',
					'type'     => 'editor',
					'class'    => 'kt-pro-feature'
				),
				array(
					'id'     => 'lite_option_8ouubfuz2x8',
					'type'   => 'section',
					'indent' => false,
				),
				array(
					'id'     => 'lite_option_9cz7jdfpaf5',
					'type'   => 'section',
					'title'    => esc_html__( 'Ask a Question', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_5rsq0ev330m',
					'type'     => 'text',
					'title'    => esc_html__( 'Title', 'teta-lite' ),
				...
				array(
					'id'       => 'lite_option_bgxvupux0lw',
					'type'     => 'editor',
					'class'    => 'kt-pro-feature'
				),
				array(
					'id'     => 'lite_option_4o9bma5m0si',
					'type'   => 'section',
					'indent' => false,
				),
			),
	...
	Redux::setSection(
		...
		array(
			...
			'id'     => 'lite_option_a06o4wud87c',
			'icon'   => 'icon-cart-full',
			'subsection' => true,
			'fields' => array(
				array(
					'id'       => 'lite_option_rz98nt7ik8q',
					'type'     => 'switch',

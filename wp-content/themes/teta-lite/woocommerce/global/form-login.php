...
>
	...
	<p class="form-row form-row-wide">
		...
		<button type="submit" class="button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="login" value="<?php esc_attr_e( 'Login', 'teta-lite' ); ?>"><?php esc_html_e( 'Login', 'teta-lite' ); ?></button>

...
<form role="search" method="get" class="woocommerce-product-search" data-type="<?php echo esc_attr( $type ); ?>" action="<?php echo esc_url( $page_url ); ?>">
	...
	<button type="submit" value="<?php echo esc_attr_x( 'Search', 'submit button', 'teta-lite' ); ?>" class="<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ); ?>"><?php echo esc_html_x( 'Search', 'submit button', 'teta-lite' ); ?></button>

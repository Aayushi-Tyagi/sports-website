...
<?php
	$clothing_store_post_sidebar = get_theme_mod( 'clothing_store_single_post_sidebar' );
	if ( 'false' == $clothing_store_post_sidebar ) {
		...
		<div class="content-area entry-content">
			<div id="main" class="site-main" role="main">
		       	<div class="row m-0">
					...
					<?php if ( 'false' != $clothing_store_post_sidebar ) {?>

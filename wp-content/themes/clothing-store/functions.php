...
function clothing_store_topbar_dropdown(){
	if(get_theme_mod('clothing_store_topbar_enable') == true ) {
		return true;
	}
	return false;
}
function clothing_store_social_dropdown(){
	if(get_theme_mod('clothing_store_social_enable') == true ) {
		return true;
	}
	return false;
}
function clothing_store_slider_dropdown(){
	if(get_theme_mod('clothing_store_slider_arrows') == true ) {
		return true;
	}
	return false;
}
function clothing_store_product_dropdown(){
	if(get_theme_mod('clothing_store_product_enable') == true ) {
		return true;
	}
	return false;
}

...
function clothing_store_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'clothing_store_shop_page_sidebar', array(
	'default'           => true,
	'transport'         => 'refresh',
	'sanitize_callback' => 'clothing_store_sanitize_checkbox',
) );
$wp_customize->add_control( new Clothing_Store_Toggle_Control( $wp_customize, 'clothing_store_shop_page_sidebar', array(
	'label'       => esc_html__( 'Show Shop Page Sidebar', 'clothing-store' ),
	'section'     => 'clothing_store_theme_settings',
	'type'        => 'toggle',
	'settings'    => 'clothing_store_shop_page_sidebar',
) ) );

$wp_customize->add_setting( 'clothing_store_wocommerce_single_page_sidebar', array(
	'default'           => true,
	'transport'         => 'refresh',
	'sanitize_callback' => 'clothing_store_sanitize_checkbox',
) );
$wp_customize->add_control( new Clothing_Store_Toggle_Control( $wp_customize, 'clothing_store_wocommerce_single_page_sidebar', array(
	'label'       => esc_html__( 'Show Shop Page Sidebar', 'clothing-store' ),
	'section'     => 'clothing_store_theme_settings',
	'type'        => 'toggle',
    ...
    $wp_customize->add_setting( 'clothing_store_topbar_enable', array(
		'default'           => false,
		'transport'         => 'refresh',
		'sanitize_callback' => 'clothing_store_sanitize_checkbox',
	) );
	$wp_customize->add_control( new Clothing_Store_Toggle_Control( $wp_customize, 'clothing_store_topbar_enable', array(
		'label'       => esc_html__( 'Check To Show Contact Details', 'clothing-store' ),
		'section'     => 'clothing_store_top',
		'type'        => 'toggle',
		'settings'    => 'clothing_store_topbar_enable',
	) ) );
	...
	$wp_customize->add_control('clothing_store_top_phone',array(
		...
		'type'    => 'text',
		'active_callback' => 'clothing_store_topbar_dropdown'
	));
    ...
    $wp_customize->add_setting( 'clothing_store_social_enable', array(
		'default'           => false,
		'transport'         => 'refresh',
		'sanitize_callback' => 'clothing_store_sanitize_checkbox',
	) );
	$wp_customize->add_control( new Clothing_Store_Toggle_Control( $wp_customize, 'clothing_store_social_enable', array(
		'label'       => esc_html__( 'Check To Show Social Media Fields', 'clothing-store' ),
	...
	$wp_customize->add_setting( 'clothing_store_product_enable', array(
		'default'           => false,
		'transport'         => 'refresh',
		'sanitize_callback' => 'clothing_store_sanitize_checkbox',
	) );
	$wp_customize->add_control( new Clothing_Store_Toggle_Control( $wp_customize, 'clothing_store_product_enable', array(
		'label'       => esc_html__( 'Check To Show Product Settings', 'clothing-store' ),
